...
const SOURCE_META = [
  ...
  { key: "PC_NATIONAL",   name: "Protezione Civile Nazionale", description: "Notizie, comunicati e allerte del Dipartimento della Protezione Civile nazionale. Filtrate per rilevanza sulla Sicilia.", url: "https://www.protezionecivile.gov.it", icon: "🇮🇹" },
  { key: "PC_SICILIA",    name: "Protezione Civile Sicilia", description: "Avvisi regionali su rischio incendi, ondate di calore e allerta idrogeologica emessi dalla Protezione Civile della Regione Siciliana.", url: "https://www.protezionecivilesicilia.it", icon: "🔥" },
  { key: "ARPA_ARIA",     name: "ARPA Sicilia — Qualità dell'Aria", description: "Dati di qualità dell'aria dalla rete di monitoraggio ARPA Sicilia. Genera allerte al superamento dei limiti EU per PM10, NO2 e O3.", url: "https://www.arpa.sicilia.it/temi-ambientali/aria/", icon: "🌬️" },
